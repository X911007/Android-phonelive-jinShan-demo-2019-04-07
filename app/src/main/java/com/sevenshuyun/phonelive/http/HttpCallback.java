...
import com.sevenshuyun.phonelive.activity.LoginInvalidActivity;
...
public abstract class HttpCallback extends AbsCallback<JsonBean> {
        ...
        if (bean != null) {
            if (200 == bean.getRet()) {
                ...
                if (data != null) {
                    ...
                    Logger.debug("服务器返回值异常--->ret: " + bean.getRet() + " msg: " + bean.getMsg());
                }
            } else {
                L.e("服务器返回值异常--->ret: " + bean.getRet() + " msg: " + bean.getMsg());
                Logger.debug("服务器返回值异常--->ret: " + bean.getRet() + " msg: " + bean.getMsg());
            ...
            Logger.debug("服务器返回值异常--->bean = null");
        }
    }
    ...
    public void onError(Response<JsonBean> response) {
        ...
        Logger.debug("网络请求错误---->" + t.getClass() + " : " + t.getMessage());
